%% This is the 1D decompression-diffusion function that is called upon by the main code (emb_diffusion_ts.m)
function [nodes, H2O_array, CO2_array] = diffusion_function_ts(P_i, P_int, P_f, lengthi, radius, H2O_i, rho, TC, dPdt_stage1, dPdt_stage2)
...
% H2O, X_mole_fraction, dD_H2O, d_H2O, d2_H2O, D_H2O, length arrays 
